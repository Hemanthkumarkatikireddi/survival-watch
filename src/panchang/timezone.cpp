...
// ============================================================
//
// Temporary default = Vizianagaram.
//
// Later real GPS module will call:
//
// setGPSLocation(latitude, longitude);
//
// ============================================================

static double currentLatitude = 18.1167;
static double currentLongitude = 83.4000;
...
{
    return utcDateTime + TimeSpan(0, 5, 30, 0);
}
...
{
    return indiaDateTime - TimeSpan(0, 5, 30, 0);
}
